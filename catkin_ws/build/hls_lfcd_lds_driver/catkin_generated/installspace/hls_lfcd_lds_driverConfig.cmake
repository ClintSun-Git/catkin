...
if("FALSE" STREQUAL "TRUE")
  ...
  set(hls_lfcd_lds_driver_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hls_lfcd_lds_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/install/${idir}'.  ${_report}")
    endif()
